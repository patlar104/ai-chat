...
<required_reading>
@/home/patri/code/ai-chat/.claude/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "/home/patri/code/ai-chat/.claude/get-shit-done/bin/gsd-tools.cjs" init resume)
