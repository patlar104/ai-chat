...
```bash
INIT=$(node "/home/patri/code/ai-chat/.claude/get-shit-done/bin/gsd-tools.cjs" init progress)
...
- `STATE=$(node "/home/patri/code/ai-chat/.claude/get-shit-done/bin/gsd-tools.cjs" state-snapshot)`
...
- Use `summary-extract` for efficient parsing:
  ```bash
  node "/home/patri/code/ai-chat/.claude/get-shit-done/bin/gsd-tools.cjs" summary-extract <path> --fields one_liner
  ```
...
PROGRESS_BAR=$(node "/home/patri/code/ai-chat/.claude/get-shit-done/bin/gsd-tools.cjs" progress bar --raw)
```
...
```bash
DEBT=$(node "/home/patri/code/ai-chat/.claude/get-shit-done/bin/gsd-tools.cjs" audit-uat --raw 2>/dev/null)
```
