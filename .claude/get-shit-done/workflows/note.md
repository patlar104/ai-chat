...
- **Global scope**: `/Users/patricklarocque/Desktop/project/ai-chat/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/patricklarocque/Desktop/project/ai-chat/.claude/notes/`)
...
2. Glob `/Users/patricklarocque/Desktop/project/ai-chat/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/patricklarocque/Desktop/project/ai-chat/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/patricklarocque/Desktop/project/ai-chat/.claude/notes/` — works in any directory
