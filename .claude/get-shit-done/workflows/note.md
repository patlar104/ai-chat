...
- **Global scope**: `/home/patri/code/ai-chat/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/patri/code/ai-chat/.claude/notes/`)
...
2. Glob `/home/patri/code/ai-chat/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/patri/code/ai-chat/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/patri/code/ai-chat/.claude/notes/` — works in any directory
