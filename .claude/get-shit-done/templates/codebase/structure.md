...
- Usage: Reference from command with `@/Users/patricklarocque/Desktop/project/ai-chat/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/patricklarocque/Desktop/project/ai-chat/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/patricklarocque/Desktop/project/ai-chat/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
