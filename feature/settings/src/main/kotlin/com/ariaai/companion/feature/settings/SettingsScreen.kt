...
fun SettingsScreen(viewModel: SettingsViewModel = hiltViewModel()) {
    ...
    Column(
        ...
        Text(
            ...
            modifier = Modifier
                .clickable { /* TODO: open privacy policy — host URL or in-app viewer */ }
        ...
        if (showClearDataDialog) {
            AlertDialog(
                ...
                text = {
                    Text(
                        "This will permanently delete all messages, memories, audit logs, reminders, " +
                            "and saved credentials. This action cannot be undone.",
                    )
                },
                confirmButton = {
                    TextButton(
