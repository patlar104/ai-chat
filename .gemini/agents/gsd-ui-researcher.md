...
Use template from `/Users/patricklarocque/Desktop/project/ai-chat/.gemini/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/patricklarocque/Desktop/project/ai-chat/.gemini/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/patricklarocque/Desktop/project/ai-chat/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
