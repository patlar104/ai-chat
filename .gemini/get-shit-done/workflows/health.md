...
```bash
node "/Users/patricklarocque/Desktop/project/ai-chat/.gemini/get-shit-done/bin/gsd-tools.cjs" validate health $REPAIR_FLAG
```
...
```bash
node "/Users/patricklarocque/Desktop/project/ai-chat/.gemini/get-shit-done/bin/gsd-tools.cjs" validate health
```
