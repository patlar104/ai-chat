...
```bash
TRANSITION=$(node "/Users/patricklarocque/Desktop/project/ai-chat/.gemini/get-shit-done/bin/gsd-tools.cjs" phase complete "${current_phase}")
```
...
```bash
PROGRESS=$(node "/Users/patricklarocque/Desktop/project/ai-chat/.gemini/get-shit-done/bin/gsd-tools.cjs" progress bar --raw)
```
...
```bash
node "/Users/patricklarocque/Desktop/project/ai-chat/.gemini/get-shit-done/bin/gsd-tools.cjs" config-set workflow._auto_chain_active false
```
